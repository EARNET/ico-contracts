...
var PreSale = artifacts.require('./Earnet2ndPresale.sol');
var Pre1Sale = artifacts.require('./Earnet2nd1mPresale.sol');
var Pre3Sale = artifacts.require('./Earnet2nd3mPresale.sol');
var Pre6Sale = artifacts.require('./Earnet2nd6mPresale.sol');
...
module.exports = function(deployer, network, accounts) {
  ...
  const prebonus = Math.floor( configData.rate * configData.presale2 / 100);
